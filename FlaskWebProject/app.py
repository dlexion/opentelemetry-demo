...
#tracer setup
tracer_provider = TracerProvider(resource=Resource.create({SERVICE_NAME: "uv-opentelemetry-python-sample"}))
trace.set_tracer_provider(tracer_provider)
TRACE_EXPORTER_ENDPOINT = os.environ.get('SERVER_TRACE_EXPORTER_ENDPOINT', 'http://localhost:4317')
exporter = OTLPSpanExporter(endpoint=TRACE_EXPORTER_ENDPOINT, insecure=True)
